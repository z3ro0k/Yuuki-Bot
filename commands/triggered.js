...
exports.run = async (client, message,  args) => {
	...
	const text = await Jimp.read('https://media.discordapp.net/attachments/414868965479940096/447622254063255555/triggered.png?width=360&height=68')
	const tint = await Jimp.read('https://media.discordapp.net/attachments/414868965479940096/447622345314533382/red.png?width=270&height=270')
