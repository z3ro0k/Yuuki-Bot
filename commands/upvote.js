...
exports.run = async (client, message, args ) => {
 ...
 let prefix = await client.tools.GuildPrefix(message.guild)
  ...
  request(options, function(error, response, body) {
   ...
   .addField('DBL Information',  `Upvotes: ${emoji}${body.points}\nCertified Bot: ${certified}\nLinks: ${body.invite ? `[\`Invite\`](${body.invite}) | ` : ""}${body.website ? `[\`Website\`](${body.website}) | ` : "" }${body.support ? `[\`Support Server\`](https://discord.gg/${body.support})` : ""} | [\`Vote\`](https://discordbots.org/bot/365949788807757834/vote)`)
